...
class ConfiguracaoGeralFactory {
    ...
    static ConfiguracaoGeral fromStringMap(Map<String, String> map) {
        ...
        Condicao2 treino = Condicao2Factory.fromStringMap(map.treino as Map<String, String>, classes)
        ...
        return new ConfiguracaoGeral(tituloConfiguracao, classes, ordem, condicao1, linhaDeBase, treino, teste1, teste2)
    }
}
